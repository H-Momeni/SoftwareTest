...
try:
    ...
    description = get_shadow_element(shop_detail, "div.description")
    print("Found button:", description.tag_name)

    # Look for the product description
    description_text = description.find_element(By.CSS_SELECTOR, "p#desc")
    print("Product Description:", description_text.text)
